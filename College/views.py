...
def students(request):
    if request.method == "POST":
        ...
        if(form.is_valid):
            form.save()
            return HttpResponseRedirect(reverse("College:students"))
        else:
            return render(request, "College/students.html",{
...
def courses(request):
    if request.method == "POST":
        ...
        if(form.is_valid):
            form.save()
            return HttpResponseRedirect(reverse("College:courses"))
        else:
...
def details(request, student_id):
    ...
    if request.method == "POST":
        ...
        return HttpResponseRedirect(reverse("College:details", args=(student_id,)))
